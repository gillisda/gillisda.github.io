...
In a this [linked file](http://github.com/gillisda/gillisda.github.io/reviewmanager-master.zip) is my Angular 2 App. This is developed in a VS Code, NodeJS, Gulp environment based on a starter project. The included README.md file has a longer description of the dev setup.
